...
# Constants
# FILENAME = 'rrtSmooth30.txt'
FILENAME = 'birrt-analysis.txt'

# Read in data
data = np.loadtxt(FILENAME, delimiter=',')

if FILENAME == 'rrtSmooth30.txt':
...
elif FILENAME == 'birrt-analysis.txt':
    means    = np.average(data, axis=1)
    variance = np.var(data, axis=1)
    ...
    print 'Bi-RRT Stats:'
    print '===================================\n'
    print 'Computation Time Bi-RRT (Mean)   : %.2f' % means[0]
    print 'Computation Time Bi-RRT (Var)    : %.2f' % variance[0]
    print 'Number of Samples (Mean)         : %.2f' % means[2]
    print 'Number of Samples (Var)          : %.2f' % variance[2]
    print 'Length of Unsmoothed Path (Mean) : %.2f' % means[3]
    print 'Length of Unsmoothed Path (Var)  : %.2f' % variance[3]
    print '\n==================================='
